...
public partial class SROptions
{
    ...
    // [Category("LLM Debug Tools"), DisplayName("Debug Aura from GPT")]
    // public void DebugAuraFromGPT()
    // {
    //     AuraAnalyzer.DebugAuraFromGPT0();
    // }

    // [Category("LLM Debug Tools"), DisplayName("Debug Aura from GPT 1")]
    // public void DebugAuraFromGPT1()
    // {
    //     AuraAnalyzer.DebugAuraFromGPT1();
    // }

    // [Category("SAVE"), DisplayName("DeleteSave")]
    // public void DeleteSave()
    // {
    //     PlayerSave.Instance.DeleteSave();
    // }

    // [Category("Cheat")]
    // public void AddCraftedItems()
    // {
    //     foreach (var item in GameManager.Instance.GameData.CraftingItemInventory.GetAll())
    //     {
    //         GameManager.Instance.Inventory.AddCraftedItemToInventory(item.ID, 10);
    //     }
    // }
    // [Category("Cheat")]
    // public void AddGameResources()
    // {
    //     foreach (var item in GameManager.Instance.GameData.ResourceInventory.GetAll())
    //     {
    //         GameManager.Instance.Inventory.AddResourceToInventory(item.ID, 10);
    //     }
    // }
    // [Category("Cheat")]
    // public void AddFood()
    // {
    //     foreach (var item in GameManager.Instance.GameData.FoodConfigInventory.GetAll())
    //     {
    //         GameManager.Instance.Inventory.AddFoodToInventory(item.ID, 10);
    //     }
    // }

    // [Category("currency")]
    // public void Add10kCurrency()
    // {
    //     GameManager.Instance.GameData.CurrenciesManager.AddCurrency(0, 10000, true);
    //     GameManager.Instance.GameData.CurrenciesManager.AddCurrency(1, 10000, true);
    // }

    // [Category("XP")]
    // public void AddXP()
    // {
    //     GameManager.Instance.GameData.PlayerData.AddPlayerXP(100);
    // }

    // [Category("Stats")]
    // public void AddNutrition()
    // {
    //     PalsManager.Instance.GetPalFromPurchaseIndex(0).NutritionStat.AddValue(10);
    // }

    // [Category("Stats")]
    // public void AddInteraction()
    // {
    //     PalsManager.Instance.GetPalFromPurchaseIndex(0).InteractionStat.AddValue(10);
    // }

    // [Category("Stats")]
    // public void AddEnergy()
    // {
    //     PalsManager.Instance.GetPalFromPurchaseIndex(0).EnergyStat.AddValue(10);
    // }
    // [Category("Stats")]
    ...
    // {
    //     FTUEManager.Instance.skipFTUE = true;
    //     FTUEManager.Instance.StopCurrentFTUE();
    // }

    // [Category("SkipLLMCall")]
    // public void SkipLLMCall()
    // {
    //     GameManager.Instance.canMakeAPICall = false;
    // }

    // [Category("SkipLLMCall")]
    // public void ContinueLLMCall()
    // {
    //     GameManager.Instance.canMakeAPICall = true;
    // }
    ...
    [Category("AuraDebug"), DisplayName("AuraDebug")]
    public void AuraDebug()
    {
        Debug.Log("[SRDebug] TestAction() invoked");
        AuraAnalyzer.DebugAuraFromGPT0();
    }
